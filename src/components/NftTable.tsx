        ...
        <div className="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                    ...
                    >
                      <div className="flex">
                        ...
                        {order === 'asc' ? (
                          <ArrowNarrowUpIcon
                            className={`h-4 w-4 ${
                              headCell.id === orderBy ? 'visible' : 'invisible'
                            }`}
                          />
                        ) : (
                          <ArrowNarrowDownIcon
          ...
          <div className="flex mt-3 justify-end h-10">
            <div className="flex justify-between w-1/4 gap-2">
              <div
                className={`w-1/5 p-1 cursor-pointer border-gray-300 bg-white rounded-md shadow-sm ${
                  curPage === 0
                    ? 'text-gray-200'
              ...
              <div className="w-1/5 text-gray-700  items-center flex">
                <span className="w-full text-center">
                  {total_count == 0 ? 0 : curPage + 1}/
