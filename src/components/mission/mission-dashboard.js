...
const MissionDashboard = (props) => {
    ...
    */
    const [nftdetailsPanel, setNftdetailsPanel] = useState({
        showPanel: false,
        isOpen: false,
        isRequired: false,
        depedentOn: '',
    ...
    const [whitelistPanel, setWhitelistPanel] = useState({
        showPanel: false,
        isOpen: false,
        isRequired: false,
        depedentOn: '',
    ...
    const [blacklistPanel, setBlacklistPanel] = useState({
        showPanel: false,
        isOpen: false,
        isRequired: false,
        depedentOn: '',
    ...
    const [royaltiesPanel, setRoyaltiesPanel] = useState({
        showPanel: false,
        isOpen: false,
        isRequired: false,
        depedentOn: '',
    ...
    const [taxesPanel, setTaxesPanel] = useState({
        showPanel: false,
        isOpen: false,
        isRequired: false,
        depedentOn: '',
    ...
    const [splitterPanel, setSplitterPanel] = useState({
        showPanel: false,
        isOpen: false,
        isRequired: false,
        depedentOn: '',
    ...
    const [timelockPanel, setTimelockPanel] = useState({
        showPanel: false,
        isOpen: false,
        isRequired: false,
        depedentOn: '',
    ...
    const [recieptPanel, setRecieptPanel] = useState({
        showPanel: false,
        isOpen: false,
        isRequired: false,
        depedentOn: '',
    ...
    const [esignPanel, setEsignPanel] = useState({
        showPanel: false,
        isOpen: false,
        isRequired: false,
        depedentOn: '',
    ...
    const [validationFault, setValidationFault] = useState({
        hasFailed: false,
        messages: [],
    })
    ...
    return (
        <div id='mission-builder-wrapper' className='m-0'>
            ...
            <div
                id='content-box'
                className='light-opacity rounded-lg text-light w-80 mt-4 mx-5 mb-2 px-2 py-4'
            >
                ...
                {props.showMissionDashboard === 'Custom' && (
                    <div>
                        <div id='content-header' className='col-12 text-center'>
                            ...
                            <p className='h5'>
                                Add and configure modules to build out your
                ...
                {props.showMissionDashboard !== 'Custom' && (
                    <div id='content-header' className='col-12 text-center'>
                        ...
                        <p className='h5'>Configure draft of your NFT.</p>
                    </div>
                )}
            ...
            */}
                ...
                <div>
                    ...
                    {props.showMissionDashboard !== 'Custom' && (
                        ...
                        >
                            <p className='h2 text-uppercase'>Add Extensions</p>
                            <p className='h5'>
                                Build governance , rules, royalties, and other
                                commercial terms directly into your NFT
                            </p>
                        </div>
                    )}
            ...
            <div className='text-center'>
                ...
                <div className='text-center  m-4'>
                    <button
                        type='button'
                        className='btn btn-primary pad-btn disabled'
                    >
                        Build Contract
                    </button>
                </div>
