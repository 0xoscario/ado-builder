...
*/
const moduleList = [
    {id: 0, name: 'Whitelist Addressess', desc: 'Set addresses allowed to allow interaction', category: "splitters", icon: './images/module-icons/import-export.jpg', action:'whitelist'},
    {id: 1, name: 'Royalties', desc: 'Fees paid to the author owner of the NFT. % or $ amt.', category: "splitters", icon: './images/module-icons/import-export.jpg', action:'royalties'},
    {id: 2, name: 'Blacklist Addresses', desc: 'A list of addresses prohibited from interacting with your NFT.', category: "splitters", icon: './images/module-icons/import-export.jpg', action:'blacklist'},
    {id: 3, name: 'Built-In Taxes', desc: 'Fees built into the NFT applied upon it\'s sale.', category: "splitters", icon: './images/module-icons/import-export.jpg', action:'taxes'},
    {id: 4, name: 'Splitting', desc: 'Assign a percentage to certain recipients.', category: "splitters", icon: './images/module-icons/import-export.jpg', action:'splitter'},
    {id: 5, name: 'Timelock', desc: 'Lock actions for a specified duration.', category: "splitters", icon: './images/module-icons/import-export.jpg', action:'timelock'},
    {id: 6, name: 'Metadata', desc: 'Create a transaction record reciept.', category: "splitters", icon: './images/module-icons/import-export.jpg', action:'metadata'},
    {id: 7, name: 'Reciept', desc: 'Add the metadata information for your NFT.', category: "splitters", icon: './images/module-icons/import-export.jpg', action:'reciept'},
    {id: 8, name: 'Electronic Signature', desc: 'Sign with an electronic signature.', category: "splitters", icon: './images/module-icons/import-export.jpg', action:'esign'}
...
const ModuleSearchResults = (props) => {    
    ...
    const showModules = filteredModuleList.map((module) => 
            <ModuleBar key={module.id} id={module.id} name={module.name} desc={module.desc} icon={module.icon} action={module.action} searchText={props.searchText} Panels={props.Panels} setPanels={props.setPanels} />
    )
