...
const Royalties = (props) => {
    ...
    return (
        <div id='royalties-panel' className='bg-white shadow sm:rounded-md sm:overflow-hidden px-4 py-4 my-4'>
            ...
            >
                ...
                <p className='h6'>
                    Fees paid to the author, owner of the NFT. By percentage or
                    flat fee.
                </p>
                <div
                    id='RoyaltiesForm'
                ...
                >
                    ...
                    <div>
                        <p className='row h6 text-primary my-4'>
                            What royalty fee would you like applied to the sale
                            of this asset?
                        </p>
                        <div className='form-group my-2'>
                            <div className='form-group'>
                                <label
                                    htmlFor='RoyaltyDescription'
                                    className='lead'
                                >
                                    Royalty Description
                                </label>
