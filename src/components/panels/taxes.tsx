...
const Taxes = (props) => {
    ...
    function addToTaxList() {
        ...
        if (rateTypeSelected === 'percent') {
            if (
                ...
                setNotify({
                    isOpen: true,
                    message: 'Entry added to tax distribution list.',
                    type: 'success',
                })
    ...
    function removeFromList(tax) {
        props.Panels.taxes.taxeslist = _.reject(
            props.Panels.taxes.taxeslist,
            tax
        )
        if (props.Panels.taxes.taxeslist.length <= 0) {
            props.Panels.taxes.isValidated = false
        } //pull validation if no addresses left

        setNotify({
            isOpen: true,
            message: 'Entry removed from tax address list.',
            type: 'warning',
        })
    }

    return (
        <div id='taxes-panel' className='bg-white shadow sm:rounded-md sm:overflow-hidden px-4 py-4 my-4'>
            <div
                id='inner-content-box'
                className={
                    props.Panels.taxes.highlight
            ...
            >
                ...
                {props.Panels.taxes.isRequired ? null : (
                ...
                <div className='custom-control custom-switch float-right'>
                    <input
                        ...
                        data-target='#TaxesForm'
                        aria-expanded='false'
                        aria-controls='TaxesForm'
                    />
                    <label
                        className='custom-control-label'
                        htmlFor='taxes-switch'
                    ></label>
                </div>
                <p className='h4 pt-1 text-uppercase'>Add Built-In Taxes</p>
                <p className='h6'>
                    Fees built into the NFT, applied upon its sale.
                </p>
                <div
                    id='TaxesForm'
                ...
                >
                    ...
                    <div>
                        <p className='row h6 text-primary my-4'>
                            What tax fee would you like applied to the sale of
                            this asset?
                        </p>
                        <div className='form-group my-2'>
                            <div className='form-group'>
                                <label
                                    htmlFor='TaxDescription'
                                    className='lead'
                                >
                                    Tax Description
                                </label>
                                <input
                                    ...
                                    id='TaxDescription'
                                    placeholder="Reciever's Share"
                                />
                                <label
                                    htmlFor='TaxDescription'
                                    className='small'
                                >
                                    *Optional - Information is solely for
                                    organizational use.
                                </label>
                            </div>
                            ...
                            <select
                                ...
                                onChange={(event) =>
                                    setRateTypeSelected(event.target.value)
                                }
                            >
                            ...
                            <div className='form-group my-5'>
                                ...
                                <label
                                    ...
                                    className='small'
                                >
                                    Address recieving funds from tax.
                                </label>
                            </div>
                        </div>
                        <hr />
