...
const AssetGallery = () => {
    return (
        ...
        >
            <div id='controls' class='d-flex justify-content-center mb-4'>
                <button
            ...
            <div id='inner' class='carousel-inner py-4'>
                <div id='single-item' class='carousel-item active'>
                    <div class='container'>
                        <div class='row'>
                            <div class='col-lg-4'>
                                <div class='card'>
                ...
                <div id='single-item-2' class='carousel-item'>
                    <div class='container'>
                        <div class='row'>
                ...
                <div id='single-item-3' class='carousel-item'>
                    <div class='container'>
                        <div class='row'>
