...
const Preloader = (props) => {
    return (
        <div id="modal-preloader" className="modal-preloader col-4 offset-lg-4 light-opacity rounded-lg text-light p-5">
            <CircularProgress />
            {/* <CircularProgress variant="determinate" value={props.loadProgress} /> */}
            <p id="loadLable" className="h4">Loading Dashboard</p>
