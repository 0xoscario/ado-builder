...
const Dashboard = (props) => {
    ...
    const { network, wallets, availableConnectTypes, availableInstallTypes } =
        useWallet()
        ...
        <div id='wrapper' className='m-0'>
            {showDash ? (
                <div id='dashWrapper' className='dash-wrapper row m-0 h-100'>
                    ...
                    <div
                        id='sidebar'
                        className='col-3 dark-opacity text-light pt-5 p-3'
                    >
                        <div
                            id='headerBar'
                        ...
                        >
                            <img
                                ...
                                className='pl-2 pb-2'
                            />
                            <p className='h1' className='display-4 pb-0 mb-0'>
                                Andromeda
                            </p>
                            ...
                            <div id='tokens' className=''>
                                ...
                                {usrBalance.map((coinBalance) => (
                                    <div
                                        key={coinBalance}
                                        id='coins'
                                        className='light-opacity rounded-lg p-4 mb-3'
                                    >
                                        <CoinBalance
                                            dspType='Dash'
                    ...
                    <div id='content' className='col'>
                        ...
                        <div className='row  text-light ml-4 mr-4 mt-1'>
                            <div className='col rounded-lg light-opacity p-4'>
                                ...
                                />
                                <p className='h5 float-left p-2'>
                                    Create an NFT Collectible, DeFi Instrument
                                    or other smart contract
                                </p>
                                <button
                                    className='btn btn-primary float-right pad-btn'
                                    onClick={() => {
                                        hideAll(), setShowTemplates(true)
                                    }}
                                >
                                    Launch Builder
                                </button>
                        ...
                        <div className='row  text-light ml-4 mr-4 mt-4'>
                            <div className='col rounded-lg light-opacity p-4'>
                                ...
                                />
                                <p className='h5 float-left p-2'>
                                    Stage and configure your entire collection
                                    to release as NFTs!
                                </p>
                                <button
                                    className='btn btn-primary float-right pad-btn'
                                    onClick={() => {
                                        hideAll(), setShowStage(true)
                                    }}
                                >
                                    Deploy Stager
                                </button>
                        ...
                        <div className='row text-light m-4'>
                            <p className='h3 col-12 display-5 mt-3'>
                                Recent Account Activity
                            </p>
                            <div className='col rounded-lg light-opacity p-4'>
                                <span className=''>
                                    Wallet connected to Andromeda Protocol
                                </span>
                                <span className='float-right'>
                                    <b>{connectionDate.toDateString()}</b>
                                </span>
                                <span className='float-right ml-4 mr-4'>|</span>{' '}
                                <span className='float-right'>
                                    {connectionDate.toTimeString()}
                                </span>
                            </div>
                        </div>
                        ...
                        <div id='value-review' className='row text-light m-3'>
                            <div className='col-6'>
                                <p className='col-12 h3 display-5 mt-3'>
                                    Account Value
                                </p>
                                <div className='light-opacity rounded-lg p-4'>
                                    <p className='col-12 h3 display-5 mt-3'>
                                        {usrWalletData.currency(
                                            usrWalletData.acctValue
                                        )}
                                        <span className='disabled'> USD</span>
                                    </p>
                                </div>
                            ...
                            <div className='col-6'>
                                <div className='row d-flex'>
                                    <p className='col h3 display-5 mt-3'>
                                        ANDR Price
                                    </p>
                                </div>
                                <div className='light-opacity rounded-lg p-4'>
                                    <div className='bright-opacity rounded-lg p-2'>
                                        <span className='col-2 offset-10 text-success'>
                                            +0.54
                                        </span>
                                        <ANDRChart />
                                    </div>
                ...
                <div id='subPageWrapper' className='m-0 p-0'>
                    ...
                    {showTransactions ? (
                        <TransactionsPage setShowDash={setShowDash} />
                    ) : null}
                    {showBurn ? <BurnPage setShowDash={setShowDash} /> : null}
                    {showArchive ? (
                        <ArchivePage setShowDash={setShowDash} />
                    ) : null}
                </div>
            )}
        </div>
