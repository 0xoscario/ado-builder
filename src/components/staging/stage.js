    ...
    return (
        <div id="stageWrapper" className="text-center text-light m-0 p-0">
            ...
            <div id="spreadsheets" className="light-opacity p-4">
                <p className="lead">Choose from one of the following spreadsheets to start organizing your colleciton for deployment.</p>
                <div className="row p-0">
                    <div className="col dark-opacity rounded-lg m-5 p-3">
                        <a href="#" target="_blank">
                            <img src="../images/module-icons/placeholder.jpg" alt="" />
            ...
            <div id="uploadWrapper" className="light-opacity rounded-lg m-5 p-4">
                ...
                <div>
                    <p className="h3">Drag and drop your completed file here.</p>
            ...
            <div id="stageProof" className="mid-opacity rounded-lg m-5 p-4">
                <p className="h1">This is where the proofing process appears after file upload.</p>
            </div>
