        ...
        return (
            <div>
                ...
                <div id="titles" className="row mt-4">
                    ...
                    <p className="col-6 h5 text-dark text-right pr-3">Balance</p>
                </div>
                <div id="titles" className="row">
                    <p className="col-6 primary">{usrWalletData.currency(usrWalletData.swapRate)}</p>
                    <p className="col-6 text-right">{usrWalletData.currency(usrWalletData.worth)}</p>
